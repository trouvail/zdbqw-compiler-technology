...
SymbolEntry* SymbolTable::lookup(std::string name)
{
    ...
    if(symbolTable[name]){
        ...
        prevSymbolTable = this->getPrev();
        while(prevSymbolTable){
            if(prevSymbolTable->symbolTable[name]){
                result = prevSymbolTable->symbolTable[name];
                return result;
            }else{
                prevSymbolTable = prevSymbolTable->getPrev();
            }
        }
    }
    return NULL;
