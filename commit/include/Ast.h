...
public:
    ...
    static void setIRBuilder(IRBuilder *ib_zyl) { builder = ib_zyl; };
    virtual void output(int level) = 0;
    void setNext(Node *node);
    void setAdjNext(Node *node_zyl) { next = node_zyl; }
};
...
public:
    ...
    void setStmt(StmtNode *stmt_zyl) { this->stmt = stmt_zyl; };
    void output(int level);
...
public:
    BreakStmt(StmtNode *whileStmt_zyl) { this->whileStmt = whileStmt_zyl; };
    bool typeCheck(Type *retType = nullptr);
    void genCode();
    void output(int level);
...
public:
    ContinueStmt(StmtNode *whileStmt_zyl) { this->whileStmt = whileStmt_zyl; };
    bool typeCheck(Type *retType = nullptr);
    void genCode();
    void output(int level);
...
public:
    ...
    void setRoot(Node *n_zyl) { root = n_zyl; }
