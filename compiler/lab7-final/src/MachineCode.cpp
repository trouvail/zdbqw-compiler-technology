                                       ...
                                       int cond)
{
    ...
    if (op == BL)
    {
        ...
        auto r0def = new MachineOperand(MachineOperand::REG, 0);
        auto r1def = new MachineOperand(MachineOperand::REG, 1);
        auto r2def = new MachineOperand(MachineOperand::REG, 2);
        auto r3def = new MachineOperand(MachineOperand::REG, 3);
        r0def->setParent(this);
        r1def->setParent(this);
        r2def->setParent(this);
        r3def->setParent(this);
        this->def_list.push_back(r0def);
        this->def_list.push_back(r1def);
        this->def_list.push_back(r2def);
        this->def_list.push_back(r3def);
        auto s0def = new MachineOperand(MachineOperand::REG, 16, true);
        auto s1def = new MachineOperand(MachineOperand::REG, 17, true);
        auto s2def = new MachineOperand(MachineOperand::REG, 18, true);
        auto s3def = new MachineOperand(MachineOperand::REG, 19, true);
        s0def->setParent(this);
        s1def->setParent(this);
        s2def->setParent(this);
        s3def->setParent(this);
        this->def_list.push_back(s0def);
        this->def_list.push_back(s1def);
        this->def_list.push_back(s2def);
        this->def_list.push_back(s3def);
...
{
    bool first = true;
    int offset = (parent->getSavedRegs().size() + parent->getSavedFpRegs().size() + 2) * 4;
